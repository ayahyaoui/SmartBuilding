...
import com.paracamplus.bcm.ports.DesktopRoomOBP;
...
public class Supervisors extends AbstractComponent{
	...
	protected Supervisors(String reflectionInboundPortURI, int nbThreads, int nbSchedulableThreads) {
